...
<title>Wouter Jordens Portfolio</title>
...
<link rel="stylesheet" type="text/css" media="screen" href="<?php echo $css.'bootstrap.css'; ?>">
<link rel="stylesheet" href="<?php echo $css.'font-awesome.css'; ?>s">
...
<div class="wrapper" id="wrapper">
		...
		<div class="parallax text-center" style="background-image: url(http://wowthemes.net/demo/leroy/img/dummy1.jpg);">
			<div class="parallax-pattern-overlay">
				<div class="container text-center" style="height:580px;padding-top:170px;">
					...
					<h2 class="intro wow zoomIn" wow-data-delay="0.4s" wow-data-duration="0.9s">Wouter Jordens Portfolio</h2>
				</div>
			</div>
		</div>
	</div>	
							...
							<div class="navArea">
								<div class="navbar-collapse collapse">
									<ul class="nav navbar-nav">
										...
										<li class="menuItem"><a href="#aboutus">Over mezelf</a></li>
										<li class="menuItem"><a href="#gallery">Galerij</a></li>
										<li class="menuItem"><a href="#contact">Contacteren</a></li>
									</ul>
								</div>
							</div>
						</div>
	...
	<div class="container">
	 ...
	 <div class="container w960">
      <div class="row">
       ...
       <form method="post" action="<?php echo base_url().'Welcome/Message'; ?>" id="contactform">
	...
	<div class="container">
		...
		<p>
			&copy; 2015 Copyright Arne Ruytings<br>
...
<script src="<?php echo $js.'/menustick.js'; ?>"></script>
...
<script src="<?php echo $js.'/masonry.js'; ?>"></script>
<script src="<?php echo $js.'/imgloaded.js'; ?>"></script>
<script src="<?php echo $js.'/classie.js'; ?>"></script>
<script src="<?php echo $js.'/colorfinder.js'; ?>"></script>
<script src="<?php echo $js.'/gridscroll.js'; ?>"></script>
